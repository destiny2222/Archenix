                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" value="{{  $service->title }}" class="form-control @error('title') is-invalid @enderror" name="title" placeholder="">
                            </div>
                            @error('name')
                        ...
                        {{-- <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <input  type="file" name="image" value="{{ $service->image }}" class="@error('image') is-invalid @enderror form-control">
                            </div>
                            @error('image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
